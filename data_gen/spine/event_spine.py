...
class OpportunityEvent:
    ...
    contract_entity_id: entity_id of the DocuSign contract generated by this opportunity.
                        None for proposals/lost deals where no contract has been signed.
    renewal_date: the end_date of the linked contract (when the deal expires and triggers
                  the next renewal cycle).  None when contract_entity_id is None.
    """
